...
- 포함: 대출 신청·금융 Snapshot, Decision Case, Kafka 신청 Event, Mock Agent·Assurance, Decision Command, Outbox·Inbox, 서비스별 PostgreSQL
...
Phase 0의 상태·Event 경계와 초기 계약이 리뷰 가능해야 한다. 산출물은 REST API, Kafka Event, Migration, Docker Image, 최소 E2E Verification이다.
