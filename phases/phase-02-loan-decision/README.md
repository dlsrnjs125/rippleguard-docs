...
- 포함: 합성 대출 데이터, Feature Schema, XGBoost 또는 LightGBM, SHAP, Loan Proposal, Model Version, LangGraph 기본 흐름, Timeout·Retry
- 제외: Consequence·Evidence 판단, 최종 대출 상태 변경, 금리 최적화
...
Phase 1 평가 요청·결과 경계와 Versioned Snapshot이 필요하다. 산출물은 Feature Schema, Model Artifact·Version, Decision Envelope, Agent Docker Image와 재현성 결과다.
