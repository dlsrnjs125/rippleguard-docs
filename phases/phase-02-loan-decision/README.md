...
- 포함: 합성 대출 데이터, Feature Schema, XGBoost·LightGBM 비교, Loan Model 선택, SHAP, Loan Proposal, Model Artifact, `TabularModelPort`, Agent Run 공통 Metadata, `StructuredLlmPort` 인터페이스 골격, Timeout·Retry
...
- Tabular Model과 LLM Provider 경계가 분리되어 있다.
