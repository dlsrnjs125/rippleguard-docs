...
Phase 2는 구현 시작 전 Contract-First 계획을 고정한다. 실제 구현은 `rippleguard-contracts`에서 실행 가능한 계약을 먼저 확정한 뒤 Repository별 독립 브랜치와 PR로 진행한다. Phase 2 상태는 구현 PR이 시작되기 전까지 `READY`로 유지한다.
