...
| 작업 | 상태 | 비고 |
| --- | --- | --- |
| Foundation 문서 | 완료 | 목적, 범위, 용어, Repository 전략 작성 |
| Architecture 문서 | 완료 | 컨텍스트, 경계, 소유권, 흐름, Agent 통제, 배포 관점 작성 |
| Domain 문서 | 완료 | Lifecycle과 Envelope 개념 정의; 계약 Schema는 아직 `TBD` |
| Governance·Tracking | 완료 | 운영 정책과 추적표 초기 구조 작성 |
