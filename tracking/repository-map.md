...
| `rippleguard-infra` | 로컬 통합 플랫폼과 Phase 1 개발용 공통 의존성 | Docker Compose, Kafka KRaft, Kafka UI, PostgreSQL, OPA, MinIO | 환경 설정, Kafka Topic, 로컬 Platform 기준 | Contracts, 각 서비스 Image |
