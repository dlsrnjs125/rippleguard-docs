...
| RISK-011 | Graph Misrepresentation | 6, 7, 9 | 중간 | 높음 | `rippleguard-audit-replay-service` | 시각적 연결이 실제 인과관계처럼 잘못 해석됨 | Link Type 명시, `causationId` 기반 검증, Timeline 대체 화면 유지 | [Graph View Model](../domain/graph-view-model.md) | 7, 9 | OPEN | - |
| RISK-012 | Sensitive Data Exposure in Graph | 6, 7, 10 | 중간 | 높음 | `rippleguard-web` | Prompt·문서·금융정보가 Graph Detail에 노출됨 | Reference 중심 Payload, RBAC, 원문 비노출 검증 | [Security and Privacy](../architecture/security-and-privacy.md) | 6, 7, 10 | OPEN | - |
