...
| RISK-015 | Image provenance cannot be verified | 1, 8, 10 | 중간 | 높음 | Primary: `rippleguard-infra`; Joint: service repositories | Manifest commit tags exist but local service images lack expected OCI source/revision labels | Require service images to carry `org.opencontainers.image.revision` and `org.opencontainers.image.source`; rerun image verification before Phase promotion | [Phase 1 Verification](../phases/phase-01-core-msa/verification.md) | 1 | OPEN | 2026-07-20 Phase 1 finalization attempt blocked `VERIFIED` promotion |
