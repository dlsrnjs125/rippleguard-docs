...
| --- | --- | --- | --- | --- |
| 0 | [Foundation & Architecture Baseline](../phases/phase-00-foundation/README.md) | IN_REVIEW | 없음 | 서비스·계약 기준과 전체 Roadmap 검증 |
| 1 | [Core MSA Foundation](../phases/phase-01-core-msa/README.md) | PLANNED | 0 | AI 없는 최소 수직 흐름, 서비스별 DB와 최소 Timeline 검증 |
...
| 7 | [Audit, Trace & Replay](../phases/phase-07-audit-replay/README.md) | PLANNED | 5, 6 | Hash Chain, 상세 Trace, Replay와 Version Diff 검증 |
...
Phase 0은 Contracts와 Infra 결과가 main에 병합됐고 검증도 확인됐지만, 현재 Docs finalization PR #4의 merge commit이 아직 Published Baseline으로 고정되지 않아 `IN_REVIEW`로 유지한다. PR #4 병합 후 Metadata PR에서 Docs merge commit을 고정하면 Phase 0은 `VERIFIED`, Phase 1은 `READY`로 전환할 수 있다.
