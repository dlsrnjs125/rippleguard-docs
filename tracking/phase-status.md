...
| 1 | [Core MSA Foundation](../phases/phase-01-core-msa/README.md) | IN_PROGRESS | 0 | AI 없는 최소 수직 흐름, 서비스별 DB와 최소 Timeline 검증 |
...
Phase 0은 Contracts, Infra, Docs finalization 결과가 main에 병합됐고 Published Baseline이 고정되어 `VERIFIED`다. Phase 1은 kickoff tracking PR에서 `IN_PROGRESS`로 시작하며, 구현 Repository는 [Phase 1 Cross-Repo Baseline](../phases/phase-01-core-msa/cross-repo-baseline.md) 순서대로 하나씩 진행한다.
