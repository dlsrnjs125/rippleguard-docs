...
| Loan Proposal | 2 | Agent Runtime | Governance Service, Audit Replay Service | Proposed outcome, score/probability, threshold, explanation refs and non-final decision metadata | TBD | NOT_STARTED | NOT_STARTED | NOT_RUN | NOT_STARTED |
| Phase 2 Decision Envelope | 2 | Agent Runtime | Governance Service, Audit Replay Service | Loan Proposal plus Snapshot, model, feature, preprocessing, artifact and validation provenance | TBD | NOT_STARTED | NOT_STARTED | NOT_RUN | NOT_STARTED |
| Agent Request Contract | 2 | Governance Service | Agent Runtime, Audit Replay Service | Fixed Snapshot and model-version execution request with correlation and causation metadata | TBD | NOT_STARTED | NOT_STARTED | NOT_RUN | NOT_STARTED |
