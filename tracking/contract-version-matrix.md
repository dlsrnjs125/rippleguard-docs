...
| `agent.evaluation.completed.v1` | 1 Mock | Governance Service | Audit Replay Service | Phase 1 mock evaluation completion trace | schema `1.0.0`, compatible minor `1.1.0` | Implemented | Implemented by Audit | Service tests PASS; runtime E2E PASS | RUNTIME_VERIFIED |
...
| Feature Schema | 2 | N/A; owner `rippleguard-contracts` | Agent Runtime, Governance Service | Versioned tabular feature names, types, required fields and validation fixtures | TBD | N/A | NOT_STARTED | NOT_RUN | NOT_STARTED |
| Versioned Snapshot Reference | 2 | Loan Service or fixture source TBD by contracts | Agent Runtime, Governance Service, Audit Replay Service | Stable Snapshot ID or content digest used for reproducible proposal generation | TBD | NOT_STARTED | NOT_STARTED | NOT_RUN | NOT_STARTED |
| Loan Proposal | 2 | Agent Runtime | Governance Service | Proposed outcome, score/probability, threshold, explanation refs and non-final decision metadata | `f4012e8b5a0dcd5605b61652a5c39deacb14454b` | IMPLEMENTED_WITH_LIMITATIONS | CONSUMER_PARTIAL | CONTRACT_PASS_E2E_BLOCKED | BLOCKED |
| Phase 2 Decision Envelope | 2 | Agent Runtime | Governance Service | Loan Proposal plus Snapshot, model, feature, preprocessing, artifact and validation provenance | `f4012e8b5a0dcd5605b61652a5c39deacb14454b` | IMPLEMENTED_WITH_LIMITATIONS | CONSUMER_PARTIAL | CONTRACT_PASS_E2E_BLOCKED | BLOCKED |
| Agent Request Contract | 2 | Governance Service | Agent Runtime | Fixed Snapshot and model-version execution request with correlation and causation metadata | TBD | NOT_STARTED | NOT_STARTED | NOT_RUN | NOT_STARTED |
| Agent Result Contract | 2 | Agent Runtime | Governance Service | Successful proposal or failure response without mock success substitution | `f4012e8b5a0dcd5605b61652a5c39deacb14454b` | IMPLEMENTED_WITH_LIMITATIONS | CONSUMER_PARTIAL | CONTRACT_PASS_E2E_BLOCKED | BLOCKED |
| Agent Result Audit Event | 2 | Governance Service | Audit Replay Service | Governance-validated or rejected Agent result trace; not raw Agent Runtime output | TBD | NOT_STARTED | NOT_STARTED | NOT_RUN | NOT_STARTED |
...
| Agent Run Metadata | 2+ | Agent Runtime | Governance Service, Audit Replay Service | Run metadata persistence | `f4012e8b5a0dcd5605b61652a5c39deacb14454b` | IMPLEMENTED_WITH_LIMITATIONS | CONSUMER_PARTIAL | CONTRACT_PASS_E2E_BLOCKED | BLOCKED |
