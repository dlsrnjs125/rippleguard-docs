...
| Loan Proposal | 2 | Agent Runtime | Governance Service | Proposed outcome, score/probability, threshold, explanation refs and non-final decision metadata | TBD | NOT_STARTED | NOT_STARTED | NOT_RUN | NOT_STARTED |
| Phase 2 Decision Envelope | 2 | Agent Runtime | Governance Service | Loan Proposal plus Snapshot, model, feature, preprocessing, artifact and validation provenance | TBD | NOT_STARTED | NOT_STARTED | NOT_RUN | NOT_STARTED |
...
| Agent Result Contract | 2 | Agent Runtime | Governance Service | Successful proposal or failure response without mock success substitution | TBD | NOT_STARTED | NOT_STARTED | NOT_RUN | NOT_STARTED |
