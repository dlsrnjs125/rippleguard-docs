...
| Static Topology Manifest | Web | Static artifact / REST TBD | Graph Node·Link DTO TBD | Architecture Graph 렌더링 | PLANNED |
...
| Contracts | Web / Audit & Replay Service | Schema / OpenAPI TBD | Graph Node·Link DTO TBD | Graph Payload와 조회 API 계약 | PLANNED |
