...
| Model Governance | Model Manifest 고정, Model Digest 확인, Ollama Runtime Version 기록, Prompt Version 기록, Provider Adapter 검증, Model Weight Git 비포함, Local LLM 장애 안전 경로 검증 | TBD | PENDING |
