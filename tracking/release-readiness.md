...
| Model Governance | Model Manifest Schema와 Instance 소유권 분리, artifact/provider/composite digest 의미 고정, source revision·license metadata 확인, Ollama Runtime Version 기록, Prompt Version 기록, Provider Adapter 검증, Model Weight Git 비포함, Local LLM 장애 안전 경로 검증 | TBD | PENDING |
